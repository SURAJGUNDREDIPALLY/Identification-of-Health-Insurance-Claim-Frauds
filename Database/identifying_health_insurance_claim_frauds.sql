...
--
-- Host: localhost
-- Generation Time: Sep 20, 2022 at 12:01 PM
...
--
-- Database: `identifying_health_insurance_claim_frauds`
--
CREATE DATABASE IF NOT EXISTS `identifying_health_insurance_claim_frauds` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `identifying_health_insurance_claim_frauds`;
...
('54ijpe9fqy11s5qs6uvtmqalnan5bx02', 'eyJ1c2VyaWQiOjF9:1oaaRj:hMorPP6o7iW3H5anhdA2JqG9Y0tirVG-uTUWB32ktiY', '2022-10-04 10:25:43.643773'),
...
('7u8i7b1srsdfyusvi7qwbumt1lp4ysjy', 'eyJ1c2VyaWQiOjJ9:1oabrN:y6tySqp0aHVdAOkmc57MmOFW6Q4aA9CV8j_E6GsSChQ', '2022-10-04 11:56:17.100695'),
...
(1, 'Ashok', 'Ashok123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(57, 'SVM', '52.0'),
(58, 'Logistic Regression', '52.0'),
(59, 'Decision Tree Classifier', '52.0'),
(60, 'KNeighborsClassifier', '48.0');
...
(17, 'No Fraud Detection', '50.0'),
(18, 'Fraud Detection', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_insurance_claim_frauds`
--

CREATE TABLE IF NOT EXISTS `remote_user_insurance_claim_frauds` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(3000) NOT NULL,
  `Sum_Insured` varchar(3000) NOT NULL,
  `age` varchar(3000) NOT NULL,
  `sex` varchar(3000) NOT NULL,
  `weight` varchar(3000) NOT NULL,
  `bmi` varchar(3000) NOT NULL,
  `hereditary_diseases` varchar(3000) NOT NULL,
  `no_of_dependents` varchar(3000) NOT NULL,
  `smoker` varchar(3000) NOT NULL,
  `city` varchar(3000) NOT NULL,
  `bloodpressure` varchar(3000) NOT NULL,
  `diabetes` varchar(3000) NOT NULL,
  `regular_ex` varchar(3000) NOT NULL,
  `job_title` varchar(3000) NOT NULL,
  `claim` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_insurance_claim_frauds`
--

INSERT INTO `remote_user_insurance_claim_frauds` (`id`, `RID`, `Sum_Insured`, `age`, `sex`, `weight`, `bmi`, `hereditary_diseases`, `no_of_dependents`, `smoker`, `city`, `bloodpressure`, `diabetes`, `regular_ex`, `job_title`, `claim`, `Prediction`) VALUES
(2, 'kao3q91w', '3,00,000', '21', 'Male', '52', '26.8', 'NoDisease', '0', '0', 'Secundarabad', '74', '1', '0', 'Actor', '1534.3', 'Fraud Detection'),
(3, 'io8zi38v', '5,00,000', '40', 'Female', '69', '29.6', 'NoDisease', '0', '0', 'Salem', '64', '1', '1', 'DataScientist', '5910.9', 'No Fraud Detection'),
(4, '4ta4gfv4', '2,00,000', '27', 'Male', '53', '18.9', 'NoDisease', '3', '0', 'Kalikat', '90', '1', '0', 'Doctor', '4827.9', 'Fraud Detection'),
(5, 'e61vrp7h', '2,00,000', '56', 'Female', '60', '39.8', 'NoDisease', '0', '0', 'SanDeigo', '60', '1', '1', 'Clerks', '11090.7', 'No Fraud Detection');
